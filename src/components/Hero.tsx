...
const Hero = () => (
  <>
    ...
    <section className="relative z-10 mx-auto max-w-6xl px-4 py-12 sm:px-6 sm:py-14 md:py-20">
        ...
        <div className="flex-1 flex justify-center md:justify-end">
          ...
          >
            <img
              ...
              alt="Hero Background"
              className="w-full max-w-4xl scale-100 md:scale-[1.8] object-contain drop-shadow-2xl"
            />
          </motion.div>
        </div>
      </div>
        ...
        <div className="flex-1 flex justify-center md:justify-start">
          ...
          >
            <img
              ...
              alt="AI Tutoring"
              className="w-full max-w-4xl scale-100 md:scale-[1.4] object-contain drop-shadow-2xl"
            />
          </motion.div>
        </div>
